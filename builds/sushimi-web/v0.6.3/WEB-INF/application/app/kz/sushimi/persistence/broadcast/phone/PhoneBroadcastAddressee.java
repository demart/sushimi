...
@Entity
@Table(name = "brc_phone_broadcast_addressees")
public class PhoneBroadcastAddressee {
	
	@Id
	@GeneratedValue(generator="brc_phone_brc_addr_seq")
	@SequenceGenerator(name="brc_phone_brc_addr_seq",sequenceName="brc_phone_brc_addr_seq", allocationSize=1)
	@Column(name="id")
	private long id;
	
	@ManyToOne
	private PhoneBroadcast broadcast;
	
	@ManyToOne
	private Phone addressee;
	...
	public PhoneBroadcast getBroadcast() {
		return broadcast;
	}

	public void setBroadcast(PhoneBroadcast broadcast) {
		this.broadcast = broadcast;
	}

	public Phone getAddressee() {
		return addressee;
	}

	public void setAddressee(Phone addressee) {
