...
public class OrderController extends Controller {
    ...
    public static void order() {
    	Logger.debug("Action [order] invoked");
    	...
    	renderTemplate("/Products/order.html", model, isCart);
    }	
    ...
    public static void searchStreetAjax(String id, String term) {
    	Logger.debug("Action [searchStreetAjax] invoked");
    ...
    public static void registerOrderAjax() {
    	Logger.debug("Action [registerOrderAjax] invoked");
    ...
    public static void completedOrder(String orderId) {
    	Logger.debug("Action [completedOrder] invoked");
    	...
    	renderTemplate("/Products/completed_order.html", orderModel);
    }	
