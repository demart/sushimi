...
public class AnnouncementController extends Controller {
	...
	public static void news() {
		Logger.debug("Action [news] invoked");
		List<String> years =  JPA.em()
				...
				.getResultList();
    	renderTemplate("Announcements/news.html", years);
	}
	
    
    public static void newsPreview(int year, int month, int date, String uniqueName) {
    	Logger.debug("Action [newsPreview] invoked");
    	...
    	renderTemplate("Announcements/news_preview.html", model, next, nextModel, prev, prevModel);
    }
    ...
    public static void newsListAjax() {
    	Logger.debug("Action [newsListAjax] invoked");
        ...
        System.out.println("News.get.Announcements.Size: " + announcements.size());
	...
	public static void actions() {
		Logger.debug("Action [actions] invoked");
		renderTemplate("Announcements/actions.html");
	}
    ...
    public static void actionsListAjax() {
    	Logger.debug("Action [actionsListAjax] invoked");
	...
	public static void actionsPreview(int year, int month, int date, String uniqueName) {
		Logger.debug("Action [actionsPreview] invoked");
    	...
    	renderTemplate("Announcements/actions_preview.html", model, daysLeftText, next, nextModel, prev, prevModel);
	}
