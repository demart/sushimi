//
//  DeliveredOrdersTableViewController.m
//  SushimiCourierApp
//
...
#import "DeliveredOrdersTableViewController.h"
...
@interface DeliveredOrdersTableViewController ()
...
@implementation DeliveredOrdersTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.destinationViewController isKindOfClass:[OrderDetailTableViewController class]]) {
        ...
        NSLog(@"DeliveredOrders List -> Order Details");
    }
}
@end
