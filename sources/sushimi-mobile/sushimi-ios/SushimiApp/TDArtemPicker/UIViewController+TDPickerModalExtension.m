...
#import "UIViewController+TDPickerModalExtension.h"
...
@implementation UIViewController (TDPickerModalExtension)
...
- (void) presentPickerModalViewController:(TDPickerModalViewController*)vc {
    ...
    [self presentPickerModalViewController:vc inView:rootView];
}

- (void) presentPickerModalViewController:(TDPickerModalViewController*)vc inView:(UIView *)rootView {
