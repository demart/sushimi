...
-(void)viewDidLoad
{
    ...
    /*
    NSTimeInterval minInterval =  2 * 60 * 60;
    [self.datePicker setMinimumDate:[[NSDate date] dateByAddingTimeInterval:minInterval]];
    NSTimeInterval maxInterval = 14 * 24 * 60 * 60;
    [self.datePicker setMaximumDate:[[NSDate date] dateByAddingTimeInterval:maxInterval]];
    
    self.datePicker.date = [[NSDate date] dateByAddingTimeInterval:minInterval];
     */
