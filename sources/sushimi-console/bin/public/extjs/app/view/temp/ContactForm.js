 ...
 */
Ext.define('SushimiConsole.view.temp.ContactForm', {
    ...
    //<example>
    requires: [
        'SushimiConsole.view.temp.ContactFormController',
        'SushimiConsole.view.temp.ContactFormWindow'
    ],
    
    exampleTitle: 'Contact Form',
    otherContent: [{
        type: 'ViewController',
        path: 'app/view/temp/ContactFormController.js'
    }, {
        type: 'Window',
        path: 'app/view/temp/ContactFormWindow.js'
    }],
    //</example>
