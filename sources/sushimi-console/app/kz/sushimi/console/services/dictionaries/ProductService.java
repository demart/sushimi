...
public class ProductService {
	...
	public static Product getProductByType(ProductType type) {
		Query productsQuery = JPA.em().createQuery("from Product where type = :type and isDeleted = false");
	...
	public static Product getProductByCode(String code) {
		Query productsQuery = JPA.em().createQuery("from Product where code = :code and isDeleted = false");
	...
	public static List<Product> getProducts(int start, int limit) {
		return JPA.em().createQuery("from Product where isDeleted = false order by name desc").setMaxResults(limit).setFirstResult(start).getResultList();
	}
