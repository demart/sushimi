...
/**
 * Модель просмотра заказов для курьеров
 * @author Wepli
 *
 */
public class ArmCourierOrdersModel {
	...
	public String getDeliveryDateDelivery(String deliveryDateDelivery) {
		return deliveryDateDelivery;
	}
