Ext.define('SushimiConsole.view.order.window.PreviewSiteOrderWindow', {
    extend: 'Ext.window.Window',
    xtype: 'preview-site-order-window',
    
    reference: 'previewSiteOrderWindow',
    controller: 'order.window.previewSiteOrderWindow',
    ...
    buttons: [{
    	reference: 'closePrewiewOrderBtn',
    	text: 'Закрыть',
