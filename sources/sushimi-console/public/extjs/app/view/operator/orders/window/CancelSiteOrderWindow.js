Ext.define('SushimiConsole.view.operator.orders.window.CancelSiteOrderWindow', {
    extend: 'Ext.window.Window',
    xtype: 'cancel-site-order-window',
    
    reference: 'cancelSiteOrderWindow',
    id: 'cancelSiteOrderWindow',
    
    alias: 'widget.operator.orders.cancelSiteWindow',
