Ext.define('SushimiConsole.view.operator.orders.window.PreviewOrderWindow', {
    extend: 'Ext.window.Window',
    xtype: 'preview-order-window',
    
    reference: 'previewOrderWindow',
    controller: 'operator.orders.window.previewOrderWindow',
    ...
    buttons: [{
    	...
    	id: 'printPreviewOrderPosPrinterBtn',
