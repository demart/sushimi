...
folder are mapped to the application's root namespace, 'SushimiManagement'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SushimiManagement"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SushimiManagement' in the same way
as `"SushimiManagement/sass/src"`.
